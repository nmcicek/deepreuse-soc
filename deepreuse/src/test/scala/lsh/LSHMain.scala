...
/**
  ...
  * }}}
  */
object LSHMain extends App {
  iotesters.Driver.execute(args, () => new LSH) {
...
/**
  ...
  * }}}
  */
object LSHRepl extends App {
  iotesters.Driver.executeFirrtlRepl(args, () => new LSH)
}