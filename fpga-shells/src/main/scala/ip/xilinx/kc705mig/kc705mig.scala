...
package fpgashells.ip.xilinx.kc705mig
...
class KC705MIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
  require((depth<=0x100000000L),"KC705MIGIODDR supports upto 4GB depth configuraton")
  ...
  val ddr3_dm               = Bits(OUTPUT,1)
  val ddr3_odt              = Bits(OUTPUT,1)

  val ddr3_dq               = Analog(8.W)
  val ddr3_dqs_n            = Analog(1.W)
  val ddr3_dqs_p            = Analog(1.W)
}

//reused directly in io bundle for sifive.blocks.devices.xilinxkc705mig
trait KC705MIGIOClocksReset extends Bundle {
  //inputs
...
class kc705mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  require((depth<=0x100000000L),"kc705mig supports upto 4GB depth configuraton")
  override def desiredName = if(depth<=0x40000000) "kc705mig1gb" else "kc705mig4gb"

  val io = new KC705MIGIODDR(depth) with KC705MIGIOClocksReset {
    // User interface signals
  ...
  val kc705mig1gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>kc705mig1gb</ModuleName>
    ...
    <Controller number="0" >
        ...
        <BankSelection>
            <Bank T2="Address/Ctrl-2" T3="DQ[0-7]" name="34" T0="Address/Ctrl-0" T1="Address/Ctrl-1" />
        </BankSelection>
        <System_Control>
            <Pin PADName="No connect" Bank="Select Bank" name="sys_rst" />
            <Pin PADName="A12" Bank="18" name="init_calib_complete" />
   ...
   val kc705mig4gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>kc705mig4gb</ModuleName>
    <dci_inouts_inputs>1</dci_inouts_inputs>
    <dci_inputs>1</dci_inputs>
    <Debug_En>OFF</Debug_En>
    <DataDepth_En>1024</DataDepth_En>
  ...
  val migprj = if(depth<=0x40000000) kc705mig1gbprj else kc705mig4gbprj
  val migprjname =  if(depth<=0x40000000) """{/kc705mig1gb.prj}""" else """{/kc705mig4gb.prj}"""
  val modulename =  if(depth<=0x40000000)  """kc705mig1gb""" else """kc705mig4gb"""
